...
public class Best_model_for_now {
    protected static final Logger log = LoggerFactory.getLogger(Best_model_for_now.class);
...
/*       for (ImageTransform transform : transforms) {
    ...
    public MultiLayerNetwork lenetModel() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .regularization(false).l2(0.03) // tried 0.0001, 0.0005
    ...
    public static void main(String[] args) throws Exception {
        new Best_model_for_now().run(args);
    }
